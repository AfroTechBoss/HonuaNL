/* global React, useApp, Icon, Avatar, SBadge, RoleChip, sMoney, sTint, AuditLine,
   MOCK_ADMIN, MOCK_APPLICATIONS */

// =====================================================================
// PRODUCTS — platform-wide listing moderation
// =====================================================================
window.AdminProducts = function AdminProducts({ products, onStatus }) {
...
// =====================================================================
window.AdminUsers = function AdminUsers({ users, onStatus, onRole }) {
  const [filter, setFilter] = React.useState('all');
  const [q, setQ] = React.useState('');
...
// =====================================================================
window.AdminSellers = function AdminSellers({ onNav }) {
  const app = useApp();
  const userPending = app.state?.sellerStatus === 'pending';
  const userApp = userPending ? {
