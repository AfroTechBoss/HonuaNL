/* global React, useApp, Icon, Avatar, Logo, SBadge, SStat, SSpark, sMoney, sTint,
   RoleChip, REPORT_REASONS, MOCK_ADMIN, MOCK_APPLICATIONS,
   AdminProducts, AdminUsers, AdminSellers, AdminActivity */
...
window.DesktopAdmin = function DesktopAdmin({ onNav }) {
  const app = useApp();
...
window.AuditLine = function AuditLine({ a, compact }) {
