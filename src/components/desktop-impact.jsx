...
window.DesktopImpact = function DesktopImpact({ onNav }) {
  const app = useApp();
  return (
          ...
          <div style={{ background: 'var(--surface)', borderRadius: 16, border: '1px solid var(--line)', padding: 22 }}>
            ...
            {[
              ...
              <div key={rank} style={{
                ...
                margin: isYou ? '0 -8px' : 0, padding: isYou ? '10px 8px' : '10px 0',
...
window.KpiCard = function KpiCard({ label, value, unit, delta, color, icon, big }) {
  return (
    <div style={{
...
window.Legend = function Legend({ color, label }) {
  return (
